...
public class FrontReviewService {
    ...
    // 1. 리뷰 등록
    public void createReview(Long bookId, ReviewCreateRequest request, List<MultipartFile> images, String cookie) {
        reviewAdaptor.createReview(bookId, request, images, cookie);
    }
